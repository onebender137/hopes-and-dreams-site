...
class HopesAndDreamsBot:
    ...
    def _beautify_for_blog(self, content, topic, image_path):
        ...
        prompt = (
            ...
            "3. MANDATORY: Structure the body using NUMBERED HEADERS for each main section. HEADERS MUST BE ALL CAPS (e.g., '1. MECHANICS', '2. BIOLOGICAL LEVERAGE').\n"
            ...
            "6. Generate a professional, punchy, and technical title for the post. TITLE MUST BE ALL CAPS (e.g., 'NEUROBIOLOGY OF SULBUTIAMINE'). Do NOT include prefixes like 'Masterclass:' or 'Topic:'.\n"
